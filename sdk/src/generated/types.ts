...
export interface paths {
    ...
    "/v1/accounts/{accountId}/email-branding/subdomain-availability": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /** Check whether a branded subdomain label is claimable (owner/manager only) */
        get: {
            parameters: {
                query: {
                    label: string;
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": components["schemas"]["EmailSubdomainAvailability"];
                    };
                };
                /** @description invalid request */
                400: {
    ...
    "/v1/accounts/{accountId}/email-branding/suggestions": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /** Suggest email branding for an account (owner/manager only) */
        get: {
            parameters: {
                query?: never;
                header?: never;
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": components["schemas"]["EmailBrandingSuggestions"];
                    };
                };
                /** @description invalid request */
                400: {
    ...
    "/v1/accounts/{accountId}/tenancies/{id}": {
        ...
        head?: never;
        /**
         * Update tenancy status or end date (area and possession facts are immutable here)
         * @description start_date remains for one compatibility release. Supplying the current value is a no-op; a changed value returns 409 date_correction_required with the audited correction endpoint.
         */
        patch: {
            parameters: {
                query?: never;
    ...
    "/v1/accounts/{accountId}/tenancies/{tenancyId}/date-context": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /** Read possession, selected lease, and selected rent dates */
        get: {
            parameters: {
                query?: {
                    lease_id?: string;
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": components["schemas"]["TenancyDateContext"];
                    };
                };
                /** @description invalid request */
                400: {
    ...
    "/v1/accounts/{accountId}/tenancies/{tenancyId}/date-corrections/preview": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        put?: never;
        /**
         * Preview a reasoned possession-date correction
        ...
        post: {
            ...
            requestBody: {
                content: {
                    "application/json": components["schemas"]["PreviewTenancyDateCorrectionBody"];
                };
            };
            responses: {
                /** @description preview */
                200: {
                    ...
                    content: {
                        "application/json": components["schemas"]["TenancyDateCorrectionPreview"];
                    };
                };
                /** @description invalid request */
                400: {
    ...
    "/v1/accounts/{accountId}/tenancies/{tenancyId}/date-corrections": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        put?: never;
        /**
         * Correct possession facts and append immutable history
        ...
        post: {
            ...
            requestBody: {
                content: {
                    "application/json": components["schemas"]["CorrectTenancyDatesBody"];
                };
            };
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": components["schemas"]["TenancyDateCommandResponse"];
                    };
                };
                /** @description invalid request */
                400: {
    ...
    "/v1/accounts/{accountId}/tenancies/{tenancyId}/date-explanations": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        get?: never;
        put?: never;
        /** Explain the selected tenancy dates without changing them */
        post: {
            parameters: {
                query?: never;
                header: {
            ...
            requestBody: {
                content: {
                    "application/json": components["schemas"]["RecordTenancyDateExplanationBody"];
                };
            };
            responses: {
    ...
    "/v1/accounts/{accountId}/tenancies/{tenancyId}/date-history": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /** List immutable tenancy date corrections and explanations */
        get: {
            parameters: {
                query?: {
                    cursor?: string;
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": components["schemas"]["TenancyDateHistoryResponse"];
                    };
                };
                /** @description invalid request */
                400: {
    ...
    "/v1/accounts/{accountId}/notices/{id}": {
         ...
         * @description A free-floating notice is fully editable (drafting is normal). A notice that anchors a live rent schedule is evidence of the increase and is write-blocked ENTIRELY: any PATCH is rejected 409 instrument_anchored — serve a new notice and change rent again, or delete the never-billed schedule to release it. Incident CITATION deliberately does not close the correction window: cited maintenance requests and inspections are equally live-hydrated, a typo fix on a cited warning is the correction path working as intended, and the audit chain keeps full before/after snapshots of every notice update.
         */
        patch: {
            parameters: {
                query?: never;
    ...
    "/v1/accounts/{accountId}/tenancies/{tenancyId}/adoption": {
        ...
        head?: never;
        /**
         * Resolve or re-raise the adoption's needs_review flag
         * @description Targets the tenancy’s single live adoption record (no id needed). Owner/manager only. Every other adoption field is frozen by a DB trigger; corrections beyond the flag are an operator soft-delete + re-adoption.
         */
        patch: {
            parameters: {
                query?: never;
            ...
            requestBody: {
                content: {
                    "application/json": components["schemas"]["PatchAdoptionBody"];
                };
            };
            responses: {
                /** @description updated */
                200: {
                    ...
                    content: {
                        "application/json": components["schemas"]["AdoptionPatched"];
                    };
                };
                /** @description invalid request */
                400: {
    ...
    "/v1/accounts/{accountId}/interactions": {
         ...
         * @description Chronological journal feed. Filters: tenancy_id, maintenance_request_id, area_id, property_id, direction, party_type, latest_only, and party_id. `party_id` matches an entry whose CAST (interaction_participants) names the person OR whose own party fields do, so a group message or witnessed exchange in which they were one of several participants matches, and so do castless entries such as a party-carrying note or a correction head that inherited the party from the entry it corrects. Combine it with party_type to narrow the matched leg to that person's tenant vs. vendor role. CAVEAT: with latest_only=true, a person named ONLY in a superseded entry's cast (a cc on a corrected message) does not match — the correction head inherits just the headline party. Omit latest_only for the complete involving-them set.
         */
        get: {
            parameters: {
                query?: {
    ...
    "/v1/accounts/{accountId}/interactions/{interactionId}/retract": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        get?: never;
        put?: never;
        /** Retract an UNVERIFIED journal entry (owner|manager): soft-deletes the row with a mandatory reason (deleted_at/by/reason stamped; hidden from default timeline reads). Only attestation=unverified rows qualify — anything else is 409. The inbound_raw receipt is untouched. */
        post: {
            parameters: {
                query?: never;
                header: {
            ...
            requestBody: {
                content: {
                    "application/json": components["schemas"]["RetractUnverifiedInteractionBody"];
                };
            };
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": components["schemas"]["RetractUnverifiedInteractionResponse"];
                    };
                };
                /** @description invalid request */
                400: {
    ...
    "/v1/accounts/{accountId}/interactions/{interactionId}/confirm-sender": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        get?: never;
        put?: never;
        /** Confirm the claimed sender of an UNVERIFIED journal entry (owner|manager): flips attestation to attested and human-links the sender address to the entry's party (link semantics: differing learned/legacy claims superseded; a differing live human claim is a 409). Future mail from the address then resolves normally. */
        post: {
            parameters: {
                query?: never;
                header: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": components["schemas"]["ConfirmUnverifiedSenderResponse"];
                    };
                };
                /** @description invalid request */
                400: {
    ...
    "/v1/accounts/{accountId}/inspections/{id}/return-to-tenant": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
...
export interface components {
    schemas: {
        ...
        EmailSubdomainAvailability: {
            label: string;
            available: boolean;
            reason: string | null;
        };
        EmailBrandingSuggestions: {
        ...
        Tenancy: {
            ...
            start_date: string;
            /** @enum {string} */
            start_date_basis: "legacy_unverified" | "possession_entitlement";
            /** Format: date */
        ...
        CreateTenancyBody: {
            ...
            /**
             * Format: date
             * @description Possession start: when the tenant is entitled or scheduled to become entitled to occupy. It is not a billing instruction.
             */
            start_date: string;
            /**
            ...
            /**
             * Format: date
             * @description Optional physical arrival date. It must describe an event that has occurred and never drives rent billing or tenancy activation.
             */
            actual_move_in_date?: string | null;
            /** Format: date */
            end_date?: string | null;
        ...
        PatchTenancyBody: {
             ...
             * Format: date
             * @deprecated
             * @description Deprecated compatibility field. The current value is accepted as a no-op. A changed value returns date_correction_required; use POST /date-corrections.
             */
            start_date?: string;
        };
        TenancyEnding: {
        ...
        TenancyDateRecord: {
            ...
            before_facts: components["schemas"]["TenancyDateFacts"];
            after_facts: components["schemas"]["TenancyDateFacts"];
            context_snapshot: {
                [key: string]: unknown;
            };
            context_fingerprint: string;
            /** @enum {string} */
            reason_code: "data_entry_error" | "possession_delayed" | "concession" | "renewal" | "early_access" | "other";
            reason_note: string;
            /** Format: uuid */
            ...
            source_document_snapshot: {
                ...
                /** @enum {string} */
                reference_kind: "content_hashes" | "unversioned_reference";
            } | null;
            /** Format: uuid */
            created_by: string;
            created_at: string;
        ...
        TenancyDateContext: {
            /** @enum {number} */
            version: 1;
            facts: components["schemas"]["TenancyDateFacts"];
            lease: {
                /** Format: uuid */
                id: string;
                term_start: string;
            ...
            context_fingerprint: string;
            information: ("date_values_differ" | "legacy_date_unverified" | "charges_in_changed_interval" | "billing_precedes_possession" | "legacy_ending_incomplete")[];
            applicable_explanation: components["schemas"]["TenancyDateRecord"];
            can_correct_start: boolean;
        };
        TenancyDateCorrectionPreview: {
            current: components["schemas"]["TenancyDateFacts"];
            proposed: components["schemas"]["TenancyDateFacts"];
            context_fingerprint: string;
            blockers: ("invalid_date_order" | "date_status_conflict" | "date_fixed_by_cancellation" | "source_scope_invalid" | "actual_move_in_in_future" | "no_date_change")[];
            information: ("date_values_differ" | "legacy_date_unverified" | "charges_in_changed_interval" | "billing_precedes_possession" | "legacy_ending_incomplete")[];
            financial_review: {
                live_charges: number;
                live_payments: number;
                charges_in_changed_interval: number;
                due_date_fallback_count: number;
                sampled_at: string;
            };
        };
        TenancyDateChanges: {
        ...
        PreviewTenancyDateCorrectionBody: {
            changes: components["schemas"]["TenancyDateChanges"];
            /** Format: uuid */
            lease_id?: string;
            /** Format: uuid */
            rent_schedule_id?: string;
        };
        TenancyDateCommandResponse: {
            tenancy: components["schemas"]["Tenancy"];
            record: components["schemas"]["TenancyDateRecord"];
        };
        CorrectTenancyDatesBody: {
            changes: components["schemas"]["TenancyDateChanges"];
            expected_date_revision: number;
            expected_context_fingerprint: string;
            /** @enum {string} */
            expected_resulting_status: "upcoming" | "active" | "ended" | "holdover";
            /** Format: uuid */
            lease_id?: string;
            /** Format: uuid */
            rent_schedule_id?: string;
        ...
        RecordTenancyDateExplanationBody: {
            expected_context_fingerprint: string;
            /** Format: uuid */
            lease_id?: string;
            /** Format: uuid */
        ...
        TenancyDateHistoryResponse: {
            data: components["schemas"]["TenancyDateRecord"][];
            next_cursor: string | null;
        };
        TenancyMember: {
            /** Format: uuid */
        ...
        PatchAdoptionBody: {
            /** @description Resolve (or re-raise) the wizard's "save as unresolved" flag. The only mutable adoption field: everything else is frozen testimony at the DB. */
            needs_review: boolean;
        };
        RentRollupRow: {
            /** Format: uuid */
        ...
        Interaction: {
            ...
            thread_id?: string | null;
            /** @enum {string|null} */
            attestation?: "provider_verified" | "attested" | "imported" | "unverified" | null;
        ...
        RetractUnverifiedInteractionResponse: {
            /** Format: uuid */
            id: string;
            deleted_at: string;
            deleted_reason: string;
        };
        RetractUnverifiedInteractionBody: {
            reason: string;
        };
        ConfirmUnverifiedSenderResponse: {
            /** Format: uuid */
            id: string;
            /** @enum {string} */
        ...
        /** @enum {string} */
        ImportBlockerCode: "missing_parent_property" | "missing_parent_area" | "parent_not_found" | "ambiguous_match" | "ambiguous_tenancy" | "unmapped_required_field" | "missing_required_field" | "unparseable_value" | "date_order" | "invalid_value" | "details_on_non_unit" | "duplicate_email";
        ImportBlocker: {
            /** @enum {string} */
            scope: "region" | "row";
            region_index: number;
