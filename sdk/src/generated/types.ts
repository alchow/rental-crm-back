...
export interface paths {
    ...
    "/v1/accounts/{accountId}/account-flags": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /** Read per-account control flags (any member, including the agent principal) */
        get: {
            parameters: {
                query?: never;
                header?: never;
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": components["schemas"]["AccountFlags"];
                    };
                };
                /** @description invalid request */
                400: {
        ...
        options?: never;
        head?: never;
        /** Update per-account control flags (owner/manager only) */
        patch: {
            parameters: {
                query?: never;
                header: {
            ...
            requestBody: {
                content: {
                    "application/json": components["schemas"]["UpdateAccountFlagsBody"];
                };
            };
            responses: {
    ...
    "/v1/accounts/{accountId}/messages": {
        ...
        get?: never;
        put?: never;
        /** Send an outbound SMS to a tenant or vendor. The intent is recorded before the provider call (ADR-0007). On success returns the created outbox row and the journal interaction. */
        post: {
            parameters: {
                query?: never;
                header: {
    ...
    "/v1/accounts/{accountId}/messages/{id}": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        get: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": components["schemas"]["MessageOutbox"];
                    };
                };
                /** @description invalid request */
                400: {
...
export interface components {
    schemas: {
        ...
        AccountFlags: {
            /** @description Litigation hold. When true, retention purges (e.g. the agent transcript purge) must delete NOTHING for this account. Authoritative in core so it survives an agent-side database wipe. */
            legal_hold: boolean;
        };
        UpdateAccountFlagsBody: {
            legal_hold?: boolean;
        };
        MaintenanceRequest: {
            /** Format: uuid */
        ...
        Interaction: {
            ...
            deleted_at: string | null;
            /** @enum {string|null} */
            delivery_status: "sending" | "sent" | "delivered" | "failed" | "undeliverable" | "needs_reconcile" | null;
