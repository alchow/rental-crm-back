 ...
 * Do not edit this file directly; change migrations and run `pnpm db:generate`.
 */
...
export type Database = {
  public: {
    Tables: {
      ...
      maintenance_request_reports: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: 'maintenance_request_reports_account_id_maintenance_request_fkey';
            columns: ['account_id', 'maintenance_request_id'];
            isOneToOne: true;
            referencedRelation: 'maintenance_requests';
            referencedColumns: ['account_id', 'id'];
    ...
    Functions: {
      ...
      _comm_resolve_identity_claims: {
        Args: {
          p_account_id: string;
          p_address: string;
          p_channel: string;
          p_party_types?: string[];
          p_tenancy_id?: string;
          p_thread_id?: string;
        };
        Returns: {
      ...
      _comm_resolve_parent_recipient: {
        Args: {
          p_account_id: string;
          p_address: string;
          p_snapshot: Json;
      ...
      _comm_resolve_persona_candidates: {
        Args: { p_account_id: string; p_from_address: string };
        Returns: {
          party_id: string;
          party_type: string;
          source: string;
      ...
      _persona_find_or_create_thread: {
        Args: {
          ...
          p_parent_tenancy_id?: string;
          p_parent_thread_id?: string;
