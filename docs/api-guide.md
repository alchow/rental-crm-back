...
| `POST` | `/rent-schedules/{id}/end`            | `end_date` (required, nullable). Sets `end_date`; the schedule stops generating charges after that date. `end_date: null` **re-opens** the schedule (clears the bound) — the undo half of a mistaken rent change: delete the mistaken successor first, then re-open the predecessor.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
