...
| `POST`  | `/leases/{id}/void`    | `void_reason` (required, non-blank, ≤500). Stamps `voided_at`/`void_reason` and returns the lease, which stays readable and listed. Returns 404 if the lease does not exist or is already voided, 409 `instrument_anchored` if a live rent schedule cites it (delete or end that schedule first).                                                                                                                                                                                                                                                                                                                                             |
