...
| Method | Path                 | Body                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| ------ | -------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `GET`  | `/interactions`      | Query filters: `tenancy_id`, `maintenance_request_id`, `area_id`, `direction`, `party_type`, `party_id`, and `latest_only=true` (returns only chain heads — the collapsed view; default returns the full set so chains can be reconstructed). **`party_id`** finds every interaction that involves one person, resolved through the **cast** (`interaction_participants`), not the legacy single-slot `party_id` — so a group message or witnessed exchange where they were one of several participants still matches; add `party_type` to narrow to that person's tenant-vs-vendor leg. **Heads caveat:** the cast belongs to the ROOT entry of a correction chain — a correction/retraction row carries no cast — so `party_id` + `latest_only=true` can exclude a corrected communication whose current head is a castless correction row. Omit `latest_only` to see every entry naming the person. |
