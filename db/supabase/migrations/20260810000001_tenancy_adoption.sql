...
--
-- p_charges:  [{amount_cents, due_date, period_start?, period_end?,
--               description?}] — all type='rent', all carrying the new
--              schedule's id (the sanctioned marker for manually materialized
--              schedule periods, per the /rent-schedules/{id}/end contract).
